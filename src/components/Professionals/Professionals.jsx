    ...
    <main className="professionals">
      ...
      <section className="professionals__material">
        ...
        <div className="professionals__material-section">
          ...
          <div className="professionals__material-card">
            <ul className="professionals__material-list">
              ...
              <p className="professionals__material-list-text">Can one-year-olds truly be creative? If we step away from artistic expressions of creativity for a moment and just think about the essence of creativity, the answer is a loud “Yes!”</p>
              </li>
              <li className="professionals__material-list-item">
              Nurturing Learning in Two-Year-Olds: Arts and Creativity
              <p className="professionals__material-list-text">When you think about art with two-year-olds, think about how to create meaningful art experiences that fit well in the busy world of twos.</p>
              </li>
              <li className="professionals__material-list-item">
              Nurturing Learning in Three- and Four-Year-Olds: Arts and Creativity
              <p className="professionals__material-list-text">During the preschool years, young children blossom in their ability to experiment with new ideas, including new ways of creating with art materials.</p>
              </li>
              <li className="professionals__material-list-item">
              Nurturing Learning in One-Year-Olds: Language and Literacy
              <p className="professionals__material-list-text">The most obvious of all of the many remarkable changes between a child’s first and second birthday is that they begin talking. As exciting as those first words are, though, they are only a slice of the language gains that one-year-olds make.</p>
              </li>
              <li className="professionals__material-list-item">
              Nurturing Learning in Two-Year-Olds: Language and Literacy
              <p className="professionals__material-list-text">Verbal communication between or with twos needs a lot of support to succeed, especially when there is a conflict of wills. But twos feel excited and powerful when they’ve succeeded in using words to connect with a friend or caregiver in a meaningful way.</p>
              </li>
              <li className="professionals__material-list-item">
              Nurturing Learning in Three- and Four-Year-Olds: Language and Literacy
              <p className="professionals__material-list-text">The ages of three and four are busy times for language and literacy learning, including developing the ability to comprehend and tell narratives, becoming much more skilled at conversation, and beginning to understand the mechanics of written language.</p>
              </li>
              <li className="professionals__material-list-item">
              Nurturing Learning in One-Year-Olds: Mathematical and Scientific Thinking
              <p className="professionals__material-list-text">By the time babies have reached their first birthday, they have logged thousands of hours of watching, listening, touching, tasting and smelling everything around them, as their rapidly developing brains have been noticing differences between things.</p>
              </li>
              <li className="professionals__material-list-item">
              Nurturing Learning in Two-Year-Olds: Mathematical and Scientific Thinking
              <p className="professionals__material-list-text">The age of two in children can be trying for caregivers, but it’s also an age in which children are gaining a remarkable amount of knowledge about how the world works.</p>
              </li>
              <li className="professionals__material-list-item">
              Nurturing Learning in Three- and Four-Year-Olds: Mathematical and Scientific Thinking
              <p className="professionals__material-list-text">Preschoolers are rapidly developing the mental abilities to think in mathematical and scientific ways in order to explore and understand their favorite topics.</p>
              </li>
              <li className="professionals__material-list-item">
              Nurturing Learning in One-Year-Olds: Play and Music
              <p className="professionals__material-list-text">Play is the central activity of young children and is the main way that young children explore, interact with, and enjoy the world around them, whether it’s an infant playing with her toes or a five-year-old playing superhero.</p>
              </li>
              <li className="professionals__material-list-item">
              Nurturing Learning in Two-Year-Olds: Play and Music
              <p className="professionals__material-list-text">What does play look like in two-year-olds, and how can caregivers support their inborn curiosity and creativity?</p>
              </li>
              <li className="professionals__material-list-item">
              Nurturing Learning in Three- and Four-Year-Olds: Play and Music
              <p className="professionals__material-list-text">Play is self-directed, pleasurable, internally motivated activity that children control. How caregivers support it depends on the age of the child.</p>
              </li>
            </ul>
          </div>
        </div>
        <div className="professionals__material-section">
          ...
          <div className="professionals__material-card">
         <p className="professionals__material-list-paragraph"><strong>Yolanda Satchell</strong> is a contractual early childhood consultant, and we are happy to have her services available to First Connections VA as a CDA Course Instructor and trainer. <br></br>
         She is the founder of the early childhood organization known as P.A.C.E. (Professional Advising & Career Empowerment). As a CDA Program Specialist, she is available to assist you with your Child Development Associates (CDA) credential questions.</p>
         <p className="professionals__material-list-paragraph">Contact her at <strong>(804)721-8536 </strong>or <strong>pace2u@comcast.net </strong>for complete program information and CDA assistance.</p>
         <p className="professionals__material-list-paragraph"><strong>Jean McNeil</strong> has been working in the early childhood field for over 35 years. She can assist your program with any technical assistance, mentoring, or coaching needs you have. Jean is also a certified CLASS mentor and rater.</p>
         <p className="professionals__material-list-paragraph">Please contact her at <strong>(804) 304-4062</strong> or <strong>jmcneil@arls.org.</strong></p>
          </div>
        </div>
      </section>
    </main>
